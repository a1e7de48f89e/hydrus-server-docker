...
```zsh
user@local:~$ docker pull a1e7de48f89e/hydrus-server-docker:379
```
...
```zsh
user@local:~$ git clone --recurse-submodules https://github.com/a1e7de48f89e/hydrus-server-docker.git
...
```zsh
user@local:~$ docker run -p 45870:45870 -p 45871:45871 -p 45872:45872 -v hydrus-server-data:/data -e CUSTOM_UID=1000 -e CUSTOM_GID=1000 -d a1e7de48f89e/hydrus-server-docker
```
